...
APP_ID = int(os.environ.get("APP_ID", "29290111"))
...
#Database
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://lijil33365:fyfygi6yt@cluster0.tamiz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "Cluster0")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002230492912"))
FORCE_SUB_CHANNEL2 = int(os.environ.get("FORCE_SUB_CHANNEL2", "-1002210310361"))
...
try:
    ADMINS=[6161643477]
    for x in (os.environ.get("ADMINS", "6161643477").split()):
        ADMINS.append(int(x))
except ValueError:
