...
async def start_command(client: Client, message: Message):
    ...
    if len(text) > 7:
        ...
        k = await client.send_message(chat_id=message.from_user.id, 
                                      text=f"<b><i>This File is deleting automatically in {file_auto_delete}. You can not take screenshot and not able to forward..!</i></b>")
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('join backup', url='https://t.me/+PZGEZNvkyAQxNDY1'),
                    InlineKeyboardButton('Premium', url='https://t.me/+WNYxazoVu1NkZTI9')
                ]
            ]
        )
